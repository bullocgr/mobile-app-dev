...
//    private RecyclerView mSavedLocationsRV;
    ...
    private SavedLocationName mName;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mSavedLocationsViewModel = new ViewModelProvider(this, new ViewModelProvider.AndroidViewModelFactory(getApplication())).get(SavedLocationsViewModel.class);
...
//        mSavedLocationsRV = findViewById(R.id.rv_saved_location);
    ...
    public void onSharedPreferenceChanged(SharedPreferences sharedPreferences, String s) {
        if(s.equals("pref_location")) {
            ...
            String forecastLocation = pref.getString("pref_location", "Corvallis, OR, US");
            mName.location_name = forecastLocation;
            mSavedLocationsViewModel.insertSavedLocation(mName);
        }
